...
class BecomeRestaurantRequest(UserMixin, db.Model):
    ...
    def __init__(self, name, celphone, email, description, status, profile_picture, cover_picture, address_lng, address_lat, user_id):
        self.name = name
